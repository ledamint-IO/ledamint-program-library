...
use lpl_token_vault::state::PREFIX;
...
mod mint_new_edition_from_master_edition_via_vault_proxy {
    ...
    async fn success() {
        ...
        program_test.add_program("lpl_token_vault", lpl_token_vault::id(), None);
    ...
    async fn fail_invalid_vault_authority() {
        ...
        assert_custom_error!(
            result,
            lpl_token_vault::error::VaultError::AuthorityDoesNotMatch
        );
    }
    ...
    async fn fail_store_account_mismatch() {
        ...
        assert_custom_error!(
            result,
            lpl_token_vault::error::VaultError::StoreDoesNotMatchSafetyDepositBox
        );
    }
}
